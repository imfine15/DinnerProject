<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<% 
String backPage = request.getContextPath() + "/views/upload/mainUploadNotice.jsp";
...
<body style="background: lightgray;">
	...
	<div style="width:80%; height:600px;margin-left: 230px; padding-top:40px; padding-left:30px;">
		...
		<div align="center" style="padding-left:10px; padding-right:10px; background: white; width:100%; padding-top: 30px; height: 800px;">
			...
			<form class="notice-form" action="<%= request.getContextPath() %>/insertAdmin.no" method="post" encType="multipart/form-data">
			<table>
				<tr>
					<td class="first">제목</td>
					<td colspan="2">
					<input type="text" style="width:890px; height:26px;" name="aTitle" id="aTitle">
					</td>
				</tr>
				<tr>
					<td class="first">내용</td>
					<td colspan="2"><textarea rows="23" cols="100" name="aContent" id="aContent"></textarea></td>
				</tr>
			<tr>
