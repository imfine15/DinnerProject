...
public class EnpVO implements java.io.Serializable{
	...
	public EnpVO(String enpNo, String enpRegisterNo, String partnerCode, int penaltyCount, String partnerId,
			...
			String hashTags, String juminNo, String enpLicense, String priceRange, String closedDay, String website,
			String introduce, String parkingPossible, double rating, String uploadApproval, int likeCount,
			String changeName, String filePath, String menuName, int menuPrice) {
		super();
		this.enpNo = enpNo;
	...
	public String toString() {
		return "EnpVO [enpNo=" + enpNo + ", enpRegisterNo=" + enpRegisterNo + ", partnerCode=" + partnerCode
				...
				+ ", hashTags=" + hashTags + ", juminNo=" + juminNo + ", enpLicense=" + enpLicense + ", priceRange="
				+ priceRange + ", closedDay=" + closedDay + ", website=" + website + ", introduce=" + introduce
				+ ", parkingPossible=" + parkingPossible + ", rating=" + rating + ", uploadApproval=" + uploadApproval
				+ ", likeCount=" + likeCount + ", changeName=" + changeName + ", filePath=" + filePath + ", menuName="
