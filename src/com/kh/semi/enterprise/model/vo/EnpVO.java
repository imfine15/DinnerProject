...
public EnpVO(String enpNo, String enpRegisterNo, String partnerCode, int penaltyCount, String partnerId,
		...
		String introduce, String parkingPossible, double rating, String uploadApproval) {
	super();
	this.enpNo = enpNo;
...
public String toString() {
	return "EnpVO [enpNo=" + enpNo + ", enpRegisterNo=" + enpRegisterNo + ", partnerCode=" + partnerCode
			...
			+ enpName + ", enpPhone=" + enpPhone + ", enpAddress=" + enpAddress + ", enpHour=" + enpHour + ", enpType="
			+ enpType + ", enpStatus=" + enpStatus + ", enpPartnerType=" + enpPartnerType + ", hashTags=" + hashTags
			+ ", juminNo=" + juminNo + ", enpLicense=" + enpLicense + ", priceRange=" + priceRange + ", closedDay="
			+ closedDay + ", website=" + website + ", introduce=" + introduce + ", parkingPossible=" + parkingPossible
			+ ", rating=" + rating + ", uploadApproval=" + uploadApproval + "]";
}
