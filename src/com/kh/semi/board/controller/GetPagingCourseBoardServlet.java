...
@WebServlet("/getCourse.bo")
public class GetPagingCourseBoardServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public GetPagingCourseBoardServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	// 전체 목록 갯수 조회
    	int listCount = new BoardService().getCourseCount();
    	...
    	ArrayList<BoardVO> courseList = new BoardService().selectCourse(sort, pi);
