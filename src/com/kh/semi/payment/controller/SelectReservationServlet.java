 ...
 */
@WebServlet("/selectReservation.ad")
public class SelectReservationServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = new ReservationService().getListCount();
		...
		ArrayList<AdminReservationVo> list = new ReservationService().selectList(pi);
		...
		if(list != null) {
			page ="views/admin/reservationHistory/reservationHistory.jsp";
